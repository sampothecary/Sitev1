...
<?php }?>
  <div class="copyright">
    <div class="container">
      <div class="left wordpress"> Copyright <?php echo '&copy; ' . date("Y") ;?> <a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php bloginfo('name'); ?></a>, All Rights Reserved <br /><?php printf( __( 'Powered by <a href="http://wordpress.org/" target="_blank">%s</a>', 'cubby' ), 'WordPress' ); ?>
	  <?php if( is_home() || is_front_page() ): ?>
	  |	  Theme : Cubby by <a href="<?php echo esc_url("http://www.mageewp.com/");?>">Mageewp Themes</a>.</div>
	    <?php endif; ?>
